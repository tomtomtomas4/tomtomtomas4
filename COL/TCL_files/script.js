document.addEventListener("DOMContentLoaded", function() {
    ...
    const heatingOpts = ["do some volunteering at your local crematorium?", "rent out one of your rooms on AirBnB & charge them for the heating?", "start a bonfire outside your local flat roof pub?", "fire up the wood burning stove? You have got one, right?", "turn off the heating at whichever home you're not currently at?", "use your BBQ as a firepit in the front room? Crack a door a jar, obviously.", "go somewhere warmer?", "get a reasonably cheap BA flight to the middle east for a few weeks?", "dig around for an old unexploded bomb from the second world war?"]
    ...
    const outingsOpts = ["takeout", "Just Eat", "Deliveroo", "Dominoes", "Papa Johns", "Burger King", "KFC", "Pizza Hut", "Mcdonalds", "Chinese takeout", "Indian", "Fish & chips", "Kebabs", "M&S", "Tesco Finest"]
